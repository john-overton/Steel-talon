...
- **The 640x480 contract.** All drawing targets a fixed 640x480 offscreen buffer, presented with largest-fit (fractional) scaling and smoothing off, via a sharp-bilinear two-pass. Game code never knows the real window size.
