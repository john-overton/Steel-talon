...
Terrain collision and terrain-aware spawning; destructible villages; minimap; SIDE/ROAM terrain; performance caching of field samples. Each waits for the pass that needs it.
