...
`src/game/sprites/shots.ts`: `TRACER` (4x8 yellow/gunmetal bullet), `MUZZLE_FLASH` (9x9 two-frame flash, alternated per shot), `ROCKET` (4x10 white-tipped rocket in flight, drawn for any bullet with `dmg >= 2`).
